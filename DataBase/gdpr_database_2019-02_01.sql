...
--
-- Host: 127.0.0.1
-- Creato il: Feb 01, 2019 alle 18:59
...
(8, 1, 'Corso di cucito', 'Nessuna descrizione disponibile', '2019-02-01', '2019-02-16', 'Non lo so', 'Aperto', '', 'Luca, Gianni, Valdino', '0000-00-00', '0000-00-00');
...
CREATE TABLE `event_typologies` (
  ...
  `et_event_repeat` varchar(20) NOT NULL COMMENT 'no repeat, daily, weekly, monthly, yearly',
...
(2, 'Urgenze privacy', 5, 2, '0', ''),
(3, 'Urgenze privacy', 5, 2, '0', ''),
(4, 'Quasi urgenze privacy', 4, 4, '0', '');
...
(2, 'lucap', 'dd4b21e9ef71e1291183a46b913ae6f2', 'l@gmail.com');
